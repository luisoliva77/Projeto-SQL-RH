...
O projeto aborda desde a criação do banco de dados até a visualização de indicadores estratégicos de RH, permitindo análises sobre funcionários, salários, benefícios, faltas e departamentos.
...
Quantidade de faltas por motivo
...
Transformação de dados em insights visuais
...
2. Power BI
Abra o arquivo .pbix
Atualize a conexão com o banco SQL Server
Atualize os dados
Filtros dinâmicos
